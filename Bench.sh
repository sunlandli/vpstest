...
speed() {
    ...
    speed_test 'http://sgp-ping.vultr.com/vultr.com.100MB.bin' 'VULTR, Singapore'
    speed_test 'http://speedtest-sgp1.digitalocean.com/100mb.test' 'DigitalOcean, 新加坡, SG'
    speed_test 'http://speedtest-nyc3.digitalocean.com/100mb.test' 'DigitalOcean, New York, NYC3'
